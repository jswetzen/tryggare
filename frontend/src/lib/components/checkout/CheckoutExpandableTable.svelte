      ...
      >
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-2">
            <span class="font-medium text-gray-900">{family.display_name}</span>
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-center gap-2">
                    ...
                    {#if child.checkInTime}
                      <span class="text-sm text-gray-500">{formatTime(child.checkInTime)}</span>
                    {/if}
                  </div>
                </div>
...
<div class="hidden md:block">
  <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
    <table class="w-full">
      <!-- Sticky header -->
      <thead class="bg-gray-50 border-b border-gray-200 sticky top-0 z-[5]">
        <tr>
