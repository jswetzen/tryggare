...
class TestQrScanCheckin(E2ETestBase, TestDataMixin):
    ...
    def setup_method(self):
        ...
        self.test_user = self.create_test_user(
            username="qrscantest", password="testpass123"
        )
    ...
    def test_family_card_expands_on_click(self):
        ...
        assert len(visible_after) > 0, "Child row should be visible after expand"
        ...
        assert len(visible_collapsed) == 0, "Child row should be hidden after collapse"
